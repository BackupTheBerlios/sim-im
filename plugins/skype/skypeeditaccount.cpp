...
skypeEditAccount::skypeEditAccount(SkypeProtocol *protocol, SIM::Account *account, QWidget *parent) : SkypeEditAccountBase(parent), SIMEditAccountWidget(account) {
