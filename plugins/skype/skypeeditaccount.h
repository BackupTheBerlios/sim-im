 ...
 */
class skypeEditAccount : public SkypeEditAccountBase, public SIMEditAccountWidget
{
Q_OBJECT
	private:
	...
	public:
		 ...
		 */
		skypeEditAccount(SkypeProtocol *protocol, SIM::Account *account, QWidget *parent = 0L);
		/**
		 * Destructor.
		 */
