...
namespace SIM
{
    ...
    public:
        ...
        virtual IMStatusPtr currentStatus(int group) = 0;
        virtual void changeStatus(const IMStatusPtr& status, int group) = 0;
        virtual IMStatusPtr savedStatus(int group) = 0;
